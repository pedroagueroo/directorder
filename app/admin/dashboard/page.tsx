...
export default function Dashboard() {
  const { todaySales, todayOrders, avgTicket, peakHour, topProducts, orderMix } = useDashboardAnalytics('test-id')
...
function MetricCard({ title, value, icon, trend, negative }: any) {
  return (
