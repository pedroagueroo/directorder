...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const [{ data: user }, { data: restaurant }, branches] = await Promise.all([
  ...
  if (!branches.some((b) => b.id === restaurantId)) redirect('/login')
  ...
  return (
    <div className="flex h-screen bg-muted/30 overflow-hidden font-sans" style={adminThemeVars}>
