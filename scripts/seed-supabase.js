...
BEGIN
  ...
  IF rid IS NOT NULL THEN
    ...
    SET brand_id = COALESCE(brand_id, rid), menu_source_restaurant_id = COALESCE(menu_source_restaurant_id, rid)
    WHERE id = rid;
  END IF;
  ...
  -- Ingredientes para personalizar en el menú público (desmarcar lo que no quieren)
